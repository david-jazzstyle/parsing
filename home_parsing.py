...
if __name__ == "__main__":
	...
	req_skin_toner = requests.get("http://www.shilladfs.com/estore/kr/ko/Skin-Care/Basic-Skin-Care/Skin-Toner/c/79?actr=1#url")
	html_skin_toner = req_skin_toner.text
	soup_skin_toner = BeautifulSoup(html_skin_toner, 'html.parser')
	...
	my_sales = soup_skin_toner.select(
		"div.pr_info"
		)
